...
const navLinks = [
  ...
  { href: "/eventos-hoy", label: "Partidos de Hoy", icon: Radio },
...
// 🔥 AHORA EL NAVBAR RECIBE EL TICKER COMO PROPIEDAD 🔥
export function Navbar({ ticker }: { ticker?: React.ReactNode }) {
  const [isOpen, setIsOpen] = useState(false)

  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5 flex flex-col">
      
      {/* AQUÍ SE RENDERIZA EL TICKER EN LA PARTE MÁS ALTA */}
      {ticker}
