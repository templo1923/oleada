          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                ...
                asChild
              >
                <Link href="https://magistvpro.shop/SportLive/index.html" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              },
              {
                ...
                desc: "TV en vivo",
                href: "https://sportlive-one.vercel.app/canales-premium",
              ...
              },
              {
                ...
                title: "Cine & Estrenos",
                desc: "Peliculas HD",
                href: "https://sportlive-one.vercel.app/cine-estrenos",
