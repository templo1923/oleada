        ...
        if ("destroy" !== o) {
            ...
            return this.each(function() {
                ...
                function u(t) {
                    ...
                    g();
                    var o = N.input.val();
                    "" !== o && (o = Number(N.input.val()),
                    N.input.val(o.toFixed(F.decimals)))
                }
                function p() {
                    F = t.extend({}, e, E, r(), o)
                }
                ...
                function d(o) {
                    ...
                    var n, s, e = B.prev(), a = B.next(), i = '<span class="input-group-addon bootstrap-touchspin-prefix">' + F.prefix + "</span>", u = '<span class="input-group-addon bootstrap-touchspin-postfix">' + F.postfix + "</span>";
                    ...
                    t(n).insertBefore(B)),
                    a.hasClass("input-group-btn") ? (s = '<button class="' + F.buttonup_class + ' bootstrap-touchspin-up" type="button">' + F.buttonup_txt + "</button>",
                ...
                function v() {
                    B.on("keydown", function(t) {
                        ...
                        38 === o ? ("up" !== A && (y(),
                        D()),
                        t.preventDefault()) : 40 === o && ("down" !== A && (_(),
                        C()),
                        t.preventDefault())
                    }),
                ...
                function g() {
                    var t, o, n;
                    "" !== (t = B.val()) ? F.decimals > 0 && "." === t || (o = parseFloat(t),
                    ...
                    o > F.max && (n = F.max),
                    n = x(n),
                    Number(t).toString() !== n.toString() && (B.val(n),
                    B.trigger("change"))) : "" !== F.replacementval && (B.val(F.replacementval),
                    B.trigger("change"))
                }
                function w() {
                    if (F.booster) {
                        var t = Math.pow(2, Math.floor(z / F.boostat)) * F.step;
                        return F.maxboostedstep && t > F.maxboostedstep && (t = F.maxboostedstep,
                        P = Math.round(P / t) * t),
                        Math.max(F.step, t)
                    }
                    return F.step
                ...
                B.data("alreadyinitialized") || (B.data("alreadyinitialized", !0),
                s += 1,
                B.data("spinnerid", s),
                B.is("input") ? (p(),
                i(),
