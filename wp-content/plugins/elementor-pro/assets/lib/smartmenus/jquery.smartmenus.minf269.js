...
(function(t) {
    ...
    function initMouseDetection(t) {
        ...
        if (mouseDetectionEnabled || t)
            mouseDetectionEnabled && t && ($(document).unbind(e),
    ...
    $.extend($.SmartMenus, {
        ...
        prototype: {
            ...
            docClick: function(t) {
                ...
                void 0) : ((this.visibleSubMenus.length && !$.contains(this.$root[0], t.target) || $(t.target).is("a")) && this.menuHideAll(),
                void 0)
            },
            ...
            itemClick: function(t) {
                ...
                if (this.handleItemEvents(e)) {
                    ...
                    if (s && !s.is(":visible")) {
                        if (this.opts.showOnClick && o && (this.clickActivated = !0),
                        this.itemActivate(e),
                        s.is(":visible"))
            ...
            menuHide: function(t) {
                if (this.$root.triggerHandler("beforehide.smapi", t[0]) !== !1 && (t.stop(!0, !0),
                "none" != t.css("display"))) {
                    var e = function() {
                        t.css("z-index", "")
                    };
            ...
            menuPosition: function(t) {
                ...
                this.opts.keepInViewport) {
                    var y = l + e
                      , I = c + i;
                    if (M && f > y ? e = g ? f - y + e : d - w : !M && y + r > f + S && (e = g ? f + S - r - y + e : w - r),
                    g || (b > h && I + h > v + b ? i += v + b - h - I : (h >= b || v > I) && (i += v - I)),
                    g && (I + h > v + b + .49 || v > I) || !g && h > b + .49) {
                        var x = this;
            ...
            menuShow: function(t) {
                ...
                !t.is(":visible"))) {
                    ...
                    if ((this.opts.keepHighlighted || this.isCollapsible()) && e.addClass("highlighted"),
                    this.isCollapsible())
